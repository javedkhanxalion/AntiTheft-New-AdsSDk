...
var id_native_screen = if (isDebug()) "ca-app-pub-3940256099942544/2247696110" else ""
var id_splash_native = if (isDebug()) "ca-app-pub-3940256099942544/2247696110" else ""
var id_app_open_screen = ""
var id_adaptive_banner = if (isDebug()) "ca-app-pub-3940256099942544/6300978111" else ""
var id_collapsable_banner = if (isDebug()) "ca-app-pub-3940256099942544/6300978111" else ""
